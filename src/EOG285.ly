...
\paper {
  ...
  ragged-bottom = ##t
  \include "override/override-EOG285.ily"
}
...
\header{
  ...
  composer = "George F. Handel, arr. by Lowell Mason" % see https://hymnary.org/tune/antioch_handel
  tagline = ##f
}
