...
patternE = { \ta c4 c4 c2 | c4 c4 \tb c2\fermata }
...
\relative c'' {
  ...
  \changePitch \patternA { d^\markup{\italic{Moderato_–bold.}} cis b a b | d, e fis }
  ...
  \changePitch \patternB { a^\f a b | cis cis d }
...
\relative f {
  ...
  \changePitch \patternE { d d g | a a, d }
