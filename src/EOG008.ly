...
\set stanza = "1."
  ...
  On Him your heav -- y bur -- den roll_– \bar "."
...
\set stanza = "2."
  ...
  Come, in His pre -- cious love con -- fide_–
...
\set stanza = "3."
  ...
  In Him for wretch -- ed sin -- ners stored_–
  Come, anx -- ious sin -- ner, come!
...
\set stanza = "4."
  ...
  To read the spir -- it’s deep -- felt sigh_–
  Come, anx -- ious sin -- ner, come!
...
\set stanza = "5."
  ...
  And soon shall heaven -- ly glo -- ry share_–
  Come, anx -- ious sin -- ner, come!
